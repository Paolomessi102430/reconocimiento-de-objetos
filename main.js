...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/YU3_APBP4/model.json',modelLoaded);
...
function gotResult(error, results) {
  ...
  if (error) {
    ...
    document.getElementById("resultado2").innerHTML = results[0].confidence.toFixed(3);
  }
}
